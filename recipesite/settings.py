...
MIDDLEWARE = [
    ...
    'recipesite.middleware.SecurityHeadersMiddleware',
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages',
                    # add pending counts for staff notifications
                    'recipes.context_processors.pending_counts',
            ],
        },
    },
]
...
# Redirect after login/logout (avoid default /accounts/profile/)
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/"
...
# Security: enable HSTS and secure cookies when running with DEBUG=False
if not DEBUG:
